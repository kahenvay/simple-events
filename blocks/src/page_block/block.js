...
registerBlockType('vl/page', {
	...
	edit: function(props) {
     ...
     <h2> Events </h2>
     <EventSelect updateAttributes={ updateAttributes } pastOrUpcoming={ pastOrUpcoming } howManyEvents={ howManyEvents } />
     { (pastOrUpcoming && howManyEvents) ? (
       <EventPreview pastOrUpcoming={ pastOrUpcoming } howManyEvents={ howManyEvents } />
       ) : (
